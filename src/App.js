...
const App = () => {
  const [data, loading] = useFetch(
    "https://raw.githubusercontent.com/mdoyle7/Exploratory-Data-Analysis/main/energy-mining.csv?token=AJBBLIBJS3EPVXADZEIEDW3ARNXKW"
  );
  /*
  ...
  */
  ...
  return (
    <div>
      ...
      <h3> Binning </h3>
      <svg width={3} height={3} style={{ border: "1px solid black" }}>
        {tmaxBins.map((bin, i) => {
          return (
            <rect
